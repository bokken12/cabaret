...
test("fetch carries a change's log to a fresh machine verbatim", async () => {
  ...
  expect(log).toMatchInlineSnapshot(`
    ...
    {"timestamp":1748000000006,"user":"alice@example.com","action":{"kind":"review","file":"widgets.txt","base":"1ac0b33426d0417f90ab4eb5ec771b5067e09a9b","tip":"9deb95270887a6eac741083f431a3b653dc6b656"}}
    "
  `);
});
