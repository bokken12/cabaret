...
export type LogAction =
  ...
  /** `edits` names the key of the comment group this entry is a version of — the root's `commentHash` for a native comment. Versions group through it, and the greatest is displayed. */
