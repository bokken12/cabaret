/** Embedded man-page documentation for the configuration file and other help.
 *  Translation of OCaml's [Patdiff_bin.Text.Readme]. */

export const readme = `.TH PATDIFF 1 "16 March 2011"
.SH NAME
