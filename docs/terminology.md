...
What should signify an inline comment needing to be addressed?
...
because I want to reclaim "TODO" in place of "CR", I need a new hame. I'm thinking "home", although I could be persuaded to "inbox"
...
"workspace" feels like the natural word as opposed to "worktree" feeling like a bespoke git-ism
...
Maybe I'll stick with "origin" by default?
...
I kind of like "archive" as most explicitly representing what happens.
